    ...
    <body>
        <div class="alert-opacity " id="alertcar">
            <div class = "carrito">
                ...
                <div class=" compra1" id="pro1">
                    ...
                    <div class="icones">
                        <i class="fa-solid fa-x" onclick="outpro()"></i>
                    </div>
                </div>
        ...
        <div class="contenedor-producto">
            ...
            <div class="select-imagen">
                <img src="Imagenes/producto2.jpg" alt="" onclick="imagen()">
            </div>
            <div class = "imagen">
                <img src="Imagenes/producto2.jpg" alt="" id="img1">
                <img src="Imagenes/producto2.jpg" alt="" id="img2" class="img2">
                
                
            </div>
            <div class="info-pro">
                <h5>Marca: E&E Art </h5><h5>Codigo: 004 </h5>
                <h1>CREMA FACIAL</h1>
                <h3>$27.000</h3>
                <h2>$16.500</h2>
            <div class="botones">
                <button class="btn-carrito" onclick="openpro4()">
                    AGREGAR AL CARRITO
                </button>
