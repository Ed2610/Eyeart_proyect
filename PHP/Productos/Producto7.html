    ...
    <body>
        ...
        <div class="contenedor-producto">
            ...
            <div class="select-imagen">
                <img src="Imagenes/jabones.png" alt="" onclick="imagen()">
            </div>
            <div class = "imagen">
                <img src="Imagenes/jabones.png" alt="" id="img1">
                
                
            </div>
            <div class="info-pro">
                <h5>Marca: E&E Art </h5><h5>Codigo: 008 </h5>
                <h1>JABON CORPORAL MARACUYA E&E ART</h1>
                <h3>$13.000</h3>
                <h2>$9.500</h2>
            <div class="botones">
                <button class="btn-carrito" onclick="openpro8()">
                    AGREGAR AL CARRITO
                </button>
