    ...
    <body>
        ...
        <div class="contenedor-producto">
            ...
            <div class="select-imagen">
                <img src="Imagenes/producto3.jpg" alt="" onclick="imagen()">
                <img src="Imagenes/producto4.jpg" alt="" onclick="imagen2()">
            </div>
            <div class = "imagen">
                <img src="Imagenes/producto3.jpg" alt="" id="img1">
                <img src="Imagenes/producto4.jpg" alt="" id="img2" class="img2">
                
                
            </div>
            <div class="info-pro">
                <h5>Marca: E&E Art </h5><h5>Codigo: 011 </h5>
                <h1>JABON DE GLICERINA MORA</h1>
                <h3>$67.000</h3>
                <h2>$57.000</h2>
            <div class="botones">
                <button class="btn-carrito" onclick="openpro11()">
                    AGREGAR AL CARRITO
                </button>
