    ...
    <body>
        ...
        <div class="contenedor-producto">
            ...
            <div class="select-imagen">
                <img src="Imagenes/velas.png" alt="" onclick="imagen()">
                <img src="Imagenes/velas.png" alt="" onclick="imagen2()">
            </div>
            <div class = "imagen">
                <img src="Imagenes/velas.png" alt="" id="img1">
                <img src="Imagenes/velas.png" alt="" id="img2" class="img2">
                
                
            </div>
            <div class="info-pro">
                <h5>Marca: E&E Art </h5><h5>Codigo: 002 </h5>
                <h1>VELA DE MANZANILLA</h1>
                <h3>$12.000</h3>
                <h2>$8.500</h2>
            <div class="botones">
                <button class="btn-carrito" onclick="openpro2()">
                    AGREGAR AL CARRITO
                </button>
